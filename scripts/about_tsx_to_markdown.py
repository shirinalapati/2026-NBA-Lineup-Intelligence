...
def main() -> None:
    ...
    inner = inner.strip() + "\n"
    banner = (
        "<!-- AUTO-GENERATED by scripts/about_tsx_to_markdown.py from AboutProject.tsx. "
        "Re-run after editing the TSX: python scripts/about_tsx_to_markdown.py -->\n\n"
    )
    OUT.write_text(banner + inner, encoding="utf-8")
